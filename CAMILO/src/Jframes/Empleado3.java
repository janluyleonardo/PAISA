...
public class Empleado3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 630, 380, 30));

        jTextField5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTextField5.setText("01/20/2006");
        ...
        jTextField4.setText("31/08/1988");
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 410, 340, 60));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 570, 170, 30));
        ...
        getContentPane().add(btnCalcularAntiguedad, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 530, 170, 30));
        ...
        txtCalcularAntiguedad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCalcularAntiguedadActionPerformed(evt);
            }
        });
        ...
        getContentPane().add(btnCalcularEdad, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 490, 170, 30));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FOTO2.jpg"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, 130, 240));

        jLabel1.setBackground(new java.awt.Color(255, 102, 102));
        jLabel1.setText("sdsdfSDA");
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 635, 140, -1));
...
txtCalcularAntiguedad.setText(entero);
    ...
    private void txtCalcularAntiguedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCalcularAntiguedadActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCalcularAntiguedadActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Empleado3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
