...
public class Empleada2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 640, 390, 30));

        jTextField5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jTextField5.setText("05/0/2010");
        ...
        jTextField4.setText("19/04/1987");
        ...
        getContentPane().add(txtCalcularEdad, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 490, 70, 30));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 410, 330, 50));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 570, 190, 30));
        ...
        getContentPane().add(btnCalcularAntiguedad, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 530, 190, 30));

        txtCalcularPrestaciones.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        txtCalcularPrestaciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCalcularPrestacionesActionPerformed(evt);
            }
        });
        getContentPane().add(txtCalcularPrestaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 570, 70, 30));

        txtCalcularAntiguedad.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        getContentPane().add(txtCalcularAntiguedad, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 530, 70, 30));
        ...
        getContentPane().add(btnCalcularEdad, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 490, 190, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 640, 130, 30));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 480, 530, 130));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FOTO3.jpg"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 140, -1));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String Salario = JOptionPane.showInputDialog(null,"¿nuevo salario mensual? ");
...
txtCalcularAntiguedad.setText(entero);
    ...
    private void txtCalcularPrestacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCalcularPrestacionesActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCalcularPrestacionesActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Empleada2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
